      ...
      <div className="dashboard flex h-screen">
        ...
        <nav className="sidebar text-white w-64 p-5 shadow-lg flex flex-col justify-between h-full">
          ...
          <ul className="list-none p-0">
            ...
            <li className="mb-3">
              <a href="/job-order" className="flex items-center p-2 hover:bg-gray-700">
                <FaClock className="mr-2" /> creat Job Order
              </a>
            </li>
            <li className="mb-3">
              <a href="/positions-filled" className="flex items-center p-2 hover:bg-gray-700">
                <FaCheckCircle className="mr-4" /> Placement Rate
              </a>
            </li>
            <li className="mb-3">
              <a href="/offers-made" className="flex items-center p-2 hover:bg-gray-700">
                <FaFileSignature className="mr-2" />Candidates Submitted 
              </a>
            </li>
            <li className="mb-3">
            ...
            <li className="mb-3">
              <a href="/average-time-to-fill" className="flex items-center p-2 hover:bg-gray-700">
                <FaClock className="mr-2" /> Source of Hire
              </a>
            </li>
            <li className="mb-3">
              <a href="/cost-per-hire" className="flex items-center p-2 hover:bg-gray-700">
                <FaDollarSign className="mr-2" /> Revenue Per Recruiter
              </a>
            </li>
            <li className="mb-3">
              <a href="/cost-per-hire" className="flex items-center p-2 hover:bg-gray-700">
        ...
        <main className="dashboard-main flex-1 p-5 bg-gray-200 relative">
          <aside className="user-profile-container w-64 p-5 shadow-lg h-full fixed right-0 top-0"
            style={{  margin: '-2rem', paddingLeft: '67rem' }}>
            <UserProfile />
          </aside>
          <section className="stats-container">
            ...
            <div className="stat-card cost-per-hire p-5 text-gray-700 rounded shadow-lg">
              <FaDollarSign className="icon text-teal-500" size={24} />
              <div>
                <h2 className="text-lg font-semibold text-left">Cost Per Hire</h2>
                <p className="text-3xl font-bold text-left">$1,500</p>
              </div>
            </div>
            <div className="stat-card client-satisfaction p-5 text-gray-700 rounded shadow-lg">
              <FaSmile className="icon text-purple-500" size={24} />
              <div>
                <h2 className="text-lg font-semibold text-left">Client Satisfaction</h2>
                <p className="text-3xl font-bold text-left">95%</p>
              </div>
            </div>
          </section>
